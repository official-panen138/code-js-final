...
from models import User, Category, Project, ProjectWhitelist, Script, AccessLog, Role, CustomDomain, PopunderCampaign
...
def project_to_dict(p: Project, include_relations: bool = False) -> dict:
    d = {
        ...
        "secondary_script_mode": p.secondary_script_mode or "js",
        "secondary_script_links": p.secondary_script_links or [],
