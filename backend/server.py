...
from models import User, Category, Project, ProjectWhitelist, Script, AccessLog, Role, CustomDomain, PopunderCampaign, PopunderWhitelist
...
async def deliver_popunder_js(campaign_file: str, request: Request, db: AsyncSession = Depends(get_db)):
    ...
    print(f"DEBUG: Popunder delivery - looking for campaign slug: {campaign_slug}", flush=True)
