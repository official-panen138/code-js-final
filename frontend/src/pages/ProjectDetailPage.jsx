          ...
          <DialogHeader>
            <DialogTitle style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
              <div className="flex items-center gap-2">
                ...
                Script Analytics - {analyticsScript?.name}
              </div>
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            {loadingScriptAnalytics ? (
              ...
              <>
                ...
                <div className="p-3 bg-slate-50 border border-border rounded-lg">
                  <Label className="label-caps text-xs text-muted-foreground">Script URL</Label>
                  <code className="block mt-1 text-sm font-mono" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                    {scriptAnalyticsData.script.url}
                  </code>
                </div>

                {/* Summary Stats */}
                <div className="grid grid-cols-3 gap-3">
                  <div className="p-3 bg-slate-50 border border-border rounded-lg text-center">
                    <div className="text-2xl font-bold" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                      {scriptAnalyticsData.summary.total}
                    </div>
                    <div className="text-xs text-muted-foreground uppercase tracking-wider">Total</div>
                  </div>
                  <div className="p-3 bg-green-50 border border-green-200 rounded-lg text-center">
                    <div className="text-2xl font-bold text-green-700" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                      {scriptAnalyticsData.summary.allowed}
                    </div>
                    <div className="text-xs text-green-600 uppercase tracking-wider">Allowed</div>
                  </div>
                  <div className="p-3 bg-red-50 border border-red-200 rounded-lg text-center">
                    <div className="text-2xl font-bold text-red-700" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                      {scriptAnalyticsData.summary.denied}
                    </div>
                    <div className="text-xs text-red-600 uppercase tracking-wider">Denied</div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {scriptAnalyticsData.logs.length === 0 ? (
                    <div className="text-center py-6 border border-dashed rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        No access logs yet. Data will appear when domains request this script.
                      </p>
                    </div>
                  ) : (
